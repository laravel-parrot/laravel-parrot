...
class PluginxDeactiveCommand extends Command
{
    protected $signature = 'p-pluginx:deactive {name}';
    protected $description = 'make pluginx deactive';
    ...
    public function handle(){
      ...
      $this->info($package.' pluginx now deactived');
    }
    ...
    {
      if (! str_contains($stub,'"status": "deactived"')) {
        $stub = str_replace(
            [
              '"status": "actived"'
            ],
